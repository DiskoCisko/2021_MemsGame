...
const task6 = [
    ...
    qs: [
      {
        title: (
          <p>
            Лапы к самиздату тянут магистраты
            <b> Дяди Стёпы</b>
          </p>
        ),
        text: [
      ...
      {
        title: <p>Бартер: за лечение в Аркхеме— Пятый Картер</p>,
        text: [
      ...
      },
      {
        title: (
          <p>
            Жёлтый символ на пиджаке — не эмблема
            <b> Carhartt</b>
          </p>
        ),
        text: [
  ...
  },
  {
    ...
    ans: ['13', '13 pro max', '12', '12 pro max', '12 mini', '11'],
  },
  {
    text: 'Поздравь Хованского. Юру таки отпустили на свободу, это ли не повод написать радостный пост в соц сети.',
  ...
  },
  {
    ...
    ans: (
      <img
        alt="loading..."
        src="https://kurjer.info/wp-content/uploads/2021/12/20211209_glavnyiy-cvet-2022.jpg"
      />
    ),
  },

  {
    ...
    qs: [
      ...
      },
      {
        title: (
          <p>
            Стёр строк больше, чем выдал
            <b> Джон Гришам</b>
          </p>
        ),
        text: ['А. Писатель', 'Б. Сценарист', 'В. Журналист', 'Г. Блогер'],
        ans: 'А. Писатель',
      },
      {
        title: (
          <p>
            Вот кто поднял выразительно бровь, не
            <b> Азат Мифтахов</b>
          </p>
        ),
        text: [
      ...
      },
      {
        ...
        text: ['А. Актер', 'Б. Певец', 'В. Танцор', 'Г. Музыкальный критик'],
        ans: 'Б. Певец',
      },
      {
        title: (
        ...
        text: ['А. Писатель', 'Б. Ученый', 'В. Поэт', 'Г. Философ'],
        ans: 'Г. Философ',
      },
      {
        title: (
          <p>
            Нос тёр жёстче разве что
            <b> Жижек</b>
          </p>
        ),
        text: ['А. Философ', 'Б. Дизайнер', 'В. Блогер', 'Г. Политик'],
        ans: 'А. Философ',
      },
    ],
  },
  ...
  {
    text: 'Вундеркинд. Восьмилетняя Алиса Теплякова сдала ЕГЭ и поступила в МГУ. Докажи, что ты не хуже. Реши верно первые 6 заданий части А ЕГЭ по обществознанию. За каждый верный ответ - 1 балл',
    img: 'https://img.joinfo.com/i/2019/07/5d29ee0fc9ca3.jpg',
  },
  {
    text: 'Привет, Андрей! Тут всё просто ищешь случайного Андрея, и начинаешь ему писать страчки из песни Привет, Андрей. Справишься, баллы твои',
    img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNVMRTZpNXs0WTIPmMCiqb7ubaMwvvKp6bJF2Y8WXMRZl3a_539Gl996bI_gS6Ty4S9vA&usqp=CAU',
  },
  {
    text: 'Вакцинация. Появился новый штамп короновируса, но не волнуйся! Сейчас тебе намутят вакцину путем смешивания напитков. Пей и живи',
    img: 'http://risovach.ru/upload/2016/10/mem/bezlimiticshe_125812673_orig_.jpg',
  },
  {
    text: 'Доставка. Чтобы мы делали в 2021 году без курьеров из службы доставки? Сейчас настала твоя пора испытать эту нелегкую ношу. Все делают тебе заказ что им принести, и ты это несешь за один раз. Удачи.',
    img: 'https://avatars.mds.yandex.net/get-zen_doc/1658683/pub_5ddf89daf45e3c5279def817_5ddf92316e457f4434247434/scale_1200',
  },
  {
    text: 'Что было дальше? Расскажи историю, но тормазни на самом интересном месте. Все кидают версии, игрок чья версия понравилась тебе больше всех получает бал, а ты свои заслуженные 6',
    img: 'https://liveam.tv/assets/images/2020/chto-bilo-dalshe.jpg',
  },
  {
    text: 'Статистика по ковид? Многие не верят официальной статистике по заболевшим, потому что считают, что она занижена. Но попробуй угадать точное число заразившихся в России.',
    img: 'https://cs10.pikabu.ru/post_img/2020/03/30/10/1585586648136648222.jpg',
  },
];
